...
A [Claude Code](https://claude.com/claude-code) skill that recommends what hero to play in **Overwatch 2 — 5v5 Role Queue Competitive**, based on the map and the enemy team composition.
...
1. Clone (or download) the [overwatch-skills](../) repo.
2. Copy this `overwatch-5v5-hero-pick/` subdirectory into your Claude Code skills folder:
...
The skill is self-contained: one `SKILL.md` + one reference file.
